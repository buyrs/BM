                        ...
                        <div class="ml-3 relative">
                            <Dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <DropdownLink :href="currentLogoutRoute()" method="post" as="button">
                                        Log Out
                                    </DropdownLink>
                                </template>
                            </Dropdown>
            ...
            >
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        <ResponsiveNavLink :href="route('checker.profile.edit')">
                            Profile
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="currentLogoutRoute()" method="post" as="button">
                            Log Out
                        </ResponsiveNavLink>
                    </div>
                </div>
