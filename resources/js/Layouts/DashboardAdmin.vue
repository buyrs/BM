<template>
    <div class="flex min-h-screen" style="background-color: var(--background-color);">
        <!-- Sidebar -->
        <aside class="w-64 bg-card shadow-md flex-shrink-0">
            <div class="p-6">
                <div class="flex items-center gap-3">
                    <svg class="text-[var(--primary-color)]" fill="none" height="32" viewBox="0 0 48 48" width="32">
                    ...
                    <h1 class="text-xl font-bold text-primary">Bail Mobilité</h1>
                </div>
            </div>
                ...
                <Link 
                    ...
                    :class="[
                        ...
                        route().current('admin.dashboard') 
                            ...
                            : 'text-secondary hover:bg-[var(--secondary-color)] hover:text-[var(--primary-color)]'
                    ]"
                >
        ...
        <div class="flex-1 flex flex-col">
            <!-- Header -->
            <header class="bg-card shadow-sm flex items-center justify-between p-4">
                <div class="flex-1">
                    <slot name="header" />
                </div>
                ...
                <div class="flex items-center gap-6">
                    ...
                    <!-- Notifications -->
                    <button class="relative text-secondary hover:text-[var(--primary-color)] transition-colors duration-200">
