<x-modern-layout>
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit Checker</h1>
        ...
        <x-card>
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Update Checker Information</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Modify the account details for this property checker.
                </p>
            </div>

            <form method="POST" action="{{ route('ops.users.update', $user->id) }}" class="p-6 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    <h4 class="text-base font-medium text-gray-900 dark:text-white mb-4">Account Information</h4>
                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div>
                                <span class="font-medium text-gray-700 dark:text-gray-300">Account Created:</span>
                                <span class="ml-1 text-gray-600 dark:text-gray-400">{{ $user->created_at->format('M d, Y') }}</span>
                            </div>
                            <div>
                                <span class="font-medium text-gray-700 dark:text-gray-300">Last Updated:</span>
                                <span class="ml-1 text-gray-600 dark:text-gray-400">{{ $user->updated_at->format('M d, Y') }}</span>
                            </div>
                            <div>
                                <span class="font-medium text-gray-700 dark:text-gray-300">User ID:</span>
                                <span class="ml-1 text-gray-600 dark:text-gray-400">#{{ $user->id }}</span>
                            </div>
                            <div>
                                <span class="font-medium text-gray-700 dark:text-gray-300">Role:</span>
                                <x-badge variant="secondary">{{ ucfirst($user->role) }}</x-badge>
                            </div>
                        </div>
                    </div>
                </div>
