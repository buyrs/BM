...
class PropertyController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('ops.properties.index', compact('properties'));
    }
    ...
    {
        return view('ops.properties.create');
    }
    ...
    {
        return view('ops.properties.show', compact('property'));
    }
    ...
    {
        return view('ops.properties.edit', compact('property'));
    }
    ...
    {
        return view('ops.properties.upload');
    }
